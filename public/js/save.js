...
function downloadImages() {
  ...
  var _loop = function _loop(_i2) {
    var table = tables.item(_i2);
    html_to_image__WEBPACK_IMPORTED_MODULE_2__.toPng(table).then(function (dataUrl) {
      (0,file_saver__WEBPACK_IMPORTED_MODULE_1__.saveAs)(dataUrl, 'image' + _i2 + '.png');
    }); //html2canvas(table.parentElement).then(canvas=>saveAs(canvas.toDataURL(), 'image'+i+'.png'));
  };

  for (var _i2 = 0; _i2 < tables.length; _i2++) {
    _loop(_i2);
  }
}
})();
